...
import com.jnetai.podcastpipe.BuildConfig
import com.jnetai.podcastpipe.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.shareButton.setOnClickListener {
            startActivity(Intent.createChooser(Intent(Intent.ACTION_SEND).apply {
                type = "text/plain"; putExtra(Intent.EXTRA_TEXT, "Check out PodcastPipe! https://github.com/jnetai-clawbot/PodcastPipe")
            }, "Share"))
        }
    }
    private fun checkForUpdates() {
        ...
        Thread {
            try {
                val json = JSONObject(URL("https://api.github.com/repos/jnetai-clawbot/PodcastPipe/releases/latest").readText())
